# Определение бизнес-процесса и примеры

## Что такое бизнес-процесс?

**Бизнес-процесс** — это повторяемая последовательность действий, в ходе которой ресурсы на входе преобразуются в конкретный результат на выходе. 
